...
function getFlutter(versionSpec) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!toolPath) {
            ...
            console.log(`toolPath is ${toolPath} after acquireFlutter`);
        }
        //
...
function acquireFlutter(release, flutterVersion) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        switch (path.extname(fileName)) {
            case '.zip':
                extPath = yield tc.extractZip(downloadPath, path.join(downloadPath, 'flutter'));
                break;
            case '.7z':
        ...
        console.log(`extPath is ${extPath}`);
        //
